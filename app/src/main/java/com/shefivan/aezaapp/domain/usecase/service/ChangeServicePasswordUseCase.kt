...
class ChangeServicePasswordUseCase @Inject constructor(
    private val repository: ServiceRepository,
    private val errors: AppErrorEmitter,
) {
    suspend operator fun invoke(id: Long, password: String) = errors.safeApiCall { repository.changePassword(id, password) }
}
