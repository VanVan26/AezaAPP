...
class ReinstallServiceUseCase @Inject constructor(
    private val repository: ServiceRepository,
    private val errors: AppErrorEmitter,
) {
    suspend operator fun invoke(id: Long, request: ReinstallServiceRequest) = errors.safeApiCall { repository.reinstall(id, request) }
}
